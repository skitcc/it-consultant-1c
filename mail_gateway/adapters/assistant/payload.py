...
OUTPUT_CONTRACT = """Формат ответа пользователю:
- В блоке рассуждений (thinking) СНАЧАЛА выпиши дословные цитаты и факты из
  документации: числа, грейды, сроки, роли, условия. Не обобщай соседние
  строки таблицы и не переноси значение с одного уровня/периода на другой.
- В ответе пользователю (content) пиши только после этих цитат.
...
3. Сопоставляй организацию, продукт, версию, период, метрику, единицы и
   грейд. Не подменяй похожие сведения (например K0 и K1).
...
Правила:
1. В thinking СНАЧАЛА выпиши дословные цитаты, которые подтверждают или
   опровергают утверждения черновика. Не смешивай строки таблиц.
2. Затем в content выдай исправленный ответ пользователю.
3. Каждое число, грейд, срок, роль и условие должны совпасть с цитатой.
   Если в источнике для K0-2 указано «покупать по K0», нельзя писать K1.
