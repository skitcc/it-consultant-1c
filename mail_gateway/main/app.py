...
def run(settings: Settings | None = None) -> None:
    ...
    assistant = GatewayAssistant(
        ...
        api_key=settings.api_gateway_api_key,
        model=settings.api_gateway_model,
        timeout_sec=settings.api_gateway_timeout_sec,
    )
    ...
    logger.info(
        "Mail gateway started mailbox=%s api_gateway=%s model=%s",
        settings.ews_email,
        settings.api_gateway_base_url,
        settings.api_gateway_model,
    )
